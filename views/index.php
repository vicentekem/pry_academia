...
<!--========================================================================= -->
    ...
    <section class="box__section">
        <div class="caja__section">
            <div class="caja__section--title">
                <h2>Lo mejor para tus hijos</h2>
            </div>
            <div class="caja__section--parrafo">
                <p>Nuestro plan de educación a virtual ha sido diseñado pensando en preparar a nuestros alumnos para los desafíos del futuro.</p>
            </div>
        </div>
    </section>
    ...
    <section class="cont__valor">
        <div class="cont__caja">
            ...
            <div class="cont__contenido">
                ...
                <!-- volor1 -->
                <div class="valor valor__pleno min__heigth">
                    <!-- icono valor -->
