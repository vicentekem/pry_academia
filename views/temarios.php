    ...
    <div class="caja__contenido">
        <div class="caja__flex">
            ...
            <div class="caja__width">
                <!-- titulo curso -->
                <h2 class="caja__title">Kubernetes desde cero</h2>
