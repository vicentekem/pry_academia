...
require_once __DIR__ . "/../controllers/validator/ConcursoValidator.php";

$validator = new ConcursoValidator();
$concurso_result = $validator->pwConcurso();
$concurso = $concurso_result["row"];
//exit( json_encode( $concurso_result ) );
if ($concurso != null) {
?>
    <section class="home box__somos contenedor-baner ">
        <div class=" container-banner">
            <!-- <img src=" public/web/assets/img/grupo/shape1.svg" alt="shape" class="shape shap1 shap11">
            <img src="public/web/assets/img/grupo/shape2.svg" alt="shape" class="shape shap2 shap22">
            <img src="public/web/assets/img/grupo/shape3.svg" alt="shape" class="shape shap3 shap33">
            <img src="public/web/assets/img/grupo/shape3.svg" alt="shape" class="shape shap4 shap44">
            <img src="public/web/assets/img/grupo/shape5.svg" alt="shape" class="shape shap5 shap55"> -->

            <div class="somos__contenedor border-baner">

                <div class="somos__caja ">
                    <div class="somos__contenido contenido-baner">
                        <h2 style="text-transform: capitalize;"><?php echo $concurso["description"]; ?></h2>
                        <p><?php echo $concurso["resumen"]; ?></p>
                        <div class="btn__go btn-2">
                            <a href="?url=inscripcion&id=<?php echo $concurso["id"]; ?>" class="btn__center">
                                ...
                                <span>Participa YA</span>
                            </a>
                        </div>
                        <div class="contenido-general">
                            <div class="contenido-asets">
                                ...
                                <div class="caja__assets ">
                                    ...
                                    <div class="curso__text curso__flex">
                                        ...
                                        <p>Fecha: <?php echo $concurso["fecha"]; ?>
                                        </p>
                                    </div>
                                    ...
                                    <div class="curso__text curso__flex">
                                        ...
                                        <p>Duración:
                                            <span style="text-transform: capitalize;"> <?php echo $concurso["hora_inicio"]; ?> </span>
                                        </p>
                                    </div>
                                    ...
                                    <div class="curso__text curso__flex">
                                        ...
                                        svg__nivel" width="1.25em" height="1.25em" viewBox="0 0 24 24" stroke-width="1.5" stroke="#7a7a7a" fill="none" stroke-linecap="round" stroke-linejoin="round">
                                            <path stroke="none" d="M0 0h24v24H0z" fill="none" />
                                            <circle cx="12" cy="11" r="3" />
                                            <path d="M17.657 16.657l-4.243 4.243a2 2 0 0 1 -2.827 0l-4.244 -4.243a8 8 0 1 1 11.314 0z" />
                                        </svg>
                                        <p>Lugar: <?php echo $concurso["direccion"]; ?> </p>
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div class="somos__img border-baner">
                    <div class="curso_img">
                        <img class="" src="<?php echo $concurso["url_img"]; ?>" alt="home image">
                    </div>
                </div>
                ...
                <!-- <div class="somos__img border-baner">
                    <div class="somos__img--caja imagen-1">
                        <img class="" src="<?php echo $concurso["url_img"]; ?>" alt="home image">
                    </div>
                </div> -->
            </div>
