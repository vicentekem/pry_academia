<script id="tmpl_view_description" type="x-tmpl-mustache">
    {{#data}}
        <div class="caja__contenido--temario">
            <div class="caja__flex">
                ...
                <div class="caja__width">
                    <!-- titulo curso -->
                    <h2 id="title" class="caja__title">{{description}}</h2>
                    <p class="caja__description  curso__text "> {{resumen}} </p>
                    ...
                    <div class="caja__assets">
                        ...
                        <div class="curso__text curso__flex">
                            ...
                            <p>Duración: <span>{{fecha_fin}}</span> </p>
                        </div>
                    </div>
                ...
                <div class="caja__conteiner">
                    <div class="caja__img">
                        <img class="caja__imagen" src={{url_img_curso}} alt="">
                    </div>
                </div>
            </div>
                ...
                <div class="banner__flex">
                    ...
                    <div class="banner__inicio">
                        <div class="banner__inicio--caja">
                            <p>inicio: <span>{{fecha_inicio}}</span> </p>
                        </div>
                    </div>
                </div>
            </div>
