                        ...
                        <div class="w-100 row px-2 pt-2 mb-0 mx-0">
                            ...
                            <div class="col-12 row mx-0">
                                ...
                                <div class="col-12 col-md-4 d-flex flex-wrap flex-md-column justify-content-center align-items-center">
                                    <button id="cbx_add" type="button" style="width: 130px;font-size: .85em;"  class="btn btn-sm btn-default m-1">Añadir</button>
                                    <button id="cbx_add_all" type="button" style="width: 130px;font-size: .85em;" class="btn btn-sm btn-default m-1">Añadir Todos</button>
                                    <button id="cbx_rmv" type="button" style="width: 130px;font-size: .85em;" class="btn btn-sm btn-default m-1">Quitar</button>
                                    <button id="cbx_rmv_all" type="button" style="width: 130px;font-size: .85em;" class="btn btn-sm btn-default m-1">Quitar Todos</button>
                                </div>
