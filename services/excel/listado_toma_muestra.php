    ...
    for($i=$inicio; $i < (count($rsA) + $inicio);$i++){
        ...
        if( $rsA[$i - $inicio]['id_paciente'] != $id_paciente_actual ){
            ...
            $objPHPExcel->setActiveSheetIndex(0)
                ...
                ->setCellValue('B' . $fila_excel, $rsA[$i - $inicio]['nrodoc'])
                ...
                ->setCellValue('Q' . $fila_excel, $rsA[$i - $inicio]['fecha_ingreso'])
                ->setCellValue('R' . $fila_excel, $rsA[$i - $inicio]['hospital'])
                ->setCellValue('S' . $fila_excel, $rsA[$i - $inicio]['fecha_alta'])
                ->setCellValue('T' . $fila_excel, $rsA[$i - $inicio]['fecha_defuncion'])


                ->setCellValue('U'  . $fila_excel, $rsA[$i - $inicio]['fiebre'] == true ? 'SI' : 'NO')
                ->setCellValue('V'  . $fila_excel, $rsA[$i - $inicio]['con_nasal'] == true ? 'SI' : 'NO')
                ->setCellValue('W'  . $fila_excel, $rsA[$i - $inicio]['malestar_gen'] == true ? 'SI' : 'NO')
                ->setCellValue('X'  . $fila_excel, $rsA[$i - $inicio]['dif_res'] == true ? 'SI' : 'NO')
                ->setCellValue('Y'  . $fila_excel, $rsA[$i - $inicio]['tos'] == true ? 'SI' : 'NO')
                ->setCellValue('Z'  . $fila_excel, $rsA[$i - $inicio]['diarrea'] == true ? 'SI' : 'NO')
                ->setCellValue('AA' . $fila_excel, $rsA[$i - $inicio]['dolor_garganta'] == true ? 'SI' : 'NO')
                ->setCellValue('AB' . $fila_excel, $rsA[$i - $inicio]['vomitos'] == true ? 'SI' : 'NO')
                ->setCellValue('AC' . $fila_excel, $rsA[$i - $inicio]['irritabilidad'] == true ? 'SI' : 'NO')
                ->setCellValue('AD' . $fila_excel, $rsA[$i - $inicio]['dol_mus'] == true ? 'SI' : 'NO')
                ->setCellValue('AE' . $fila_excel, $rsA[$i - $inicio]['dol_pec'] == true ? 'SI' : 'NO')
                ->setCellValue('AF' . $fila_excel, $rsA[$i - $inicio]['dol_adb'] == true ? 'SI' : 'NO')
                ->setCellValue('AG' . $fila_excel, $rsA[$i - $inicio]['dol_art'] == true ? 'SI' : 'NO')
                ->setCellValue('AH' . $fila_excel, $rsA[$i - $inicio]['cefalea'] == true ? 'SI' : 'NO')
                ->setCellValue('AI' . $fila_excel,
                    $rsA[$i - $inicio]['otros'] == true ? $rsA[$i - $inicio]['sintoma_desc'] == true : '')


                ->setCellValue('AJ' . $fila_excel, $rsA[$i - $inicio]['temperatura'])
                ->setCellValue('AK' . $fila_excel, $rsA[$i - $inicio]['cc_embarazo'] == true ? 'SI' : 'NO')
                ->setCellValue('AL' . $fila_excel, $rsA[$i - $inicio]['cc_pos_parto'] == true ? 'SI' : 'NO')
                ->setCellValue('AM' . $fila_excel, $rsA[$i - $inicio]['cc_enf_car'] == true ? 'SI' : 'NO')
                ->setCellValue('AN' . $fila_excel, $rsA[$i - $inicio]['cc_inmunodeficiencia'] == true ? 'SI' : 'NO')
                ->setCellValue('AO' . $fila_excel, $rsA[$i - $inicio]['cc_diabetes'] == true ? 'SI' : 'NO')
                ->setCellValue('AP' . $fila_excel, $rsA[$i - $inicio]['cc_enf_ren'] == true ? 'SI' : 'NO')
                ->setCellValue('AQ' . $fila_excel, $rsA[$i - $inicio]['cc_enf_hep'] == true ? 'SI' : 'NO')
                ->setCellValue('AR' . $fila_excel, $rsA[$i - $inicio]['cc_dan_hep'] == true ? 'SI' : 'NO')
                ->setCellValue('AS' . $fila_excel, $rsA[$i - $inicio]['cc_enf_cro'] == true ? 'SI' : 'NO')
                ->setCellValue('AT' . $fila_excel, $rsA[$i - $inicio]['cc_enf_pul'] == true ? 'SI' : 'NO')
                ->setCellValue('AU' . $fila_excel, $rsA[$i - $inicio]['cc_otros'] == true ? $rsA[$i - $inicio]['cc_desc'] : '')

                ->setCellValue('AV' . $fila_excel, $rsA[$i - $inicio]['ocupacion_paciente'])
                ->setCellValue('AW' . $fila_excel, $rsA[$i - $inicio]['evolucion_paciente'])
                ->setCellValue('AX' . $fila_excel, $rsA[$i - $inicio]['fecha_atendido'])
                ->setCellValue('BM' . $fila_excel, $rsA[$i - $inicio]['nueva_data'] == 'SI' ? 'SI' : 'NO' );

            if(isset($rsA[($i - $inicio) + 0  ]) ){
                $objPHPExcel->setActiveSheetIndex(0)
                    ->setCellValue('AY' .  $fila_excel, $rsA[($i - $inicio) + 0  ]['id_paciente'] == $id_paciente_actual ? $rsA[($i - $inicio) + 0  ]['estado_evolucion_pac']  : '');
            }

            if(isset($rsA[($i - $inicio) + 1  ])){
                $objPHPExcel->setActiveSheetIndex(0)
                    ->setCellValue('AZ' .  $fila_excel, $rsA[($i - $inicio) + 1  ]['id_paciente'] == $id_paciente_actual ? $rsA[($i - $inicio) + 1  ]['estado_evolucion_pac']  : '');
            }

            if(isset($rsA[($i - $inicio) + 2  ])){
                $objPHPExcel->setActiveSheetIndex(0)
                    ->setCellValue('BA' .  $fila_excel, $rsA[($i - $inicio) + 2  ]['id_paciente'] == $id_paciente_actual ? $rsA[($i - $inicio) + 2  ]['estado_evolucion_pac']  : '');
            }

            if(isset($rsA[($i - $inicio) + 3 ])){
                $objPHPExcel->setActiveSheetIndex(0)
                    ->setCellValue('BB' .  $fila_excel, $rsA[($i - $inicio) + 3  ]['id_paciente'] == $id_paciente_actual ? $rsA[($i - $inicio) + 3  ]['estado_evolucion_pac']  : '');
            }

            if(isset($rsA[($i - $inicio) + 4 ])){
                $objPHPExcel->setActiveSheetIndex(0)
                    ->setCellValue('BC' . $fila_excel, $rsA[($i - $inicio) + 4  ]['id_paciente'] == $id_paciente_actual ? $rsA[($i - $inicio) + 4  ]['estado_evolucion_pac']  : '');
            }

            if(isset($rsA[($i - $inicio) + 5 ])){
                $objPHPExcel->setActiveSheetIndex(0)
                    ->setCellValue('BD' . $fila_excel, $rsA[($i - $inicio) + 5  ]['id_paciente'] == $id_paciente_actual ? $rsA[($i - $inicio) + 5  ]['estado_evolucion_pac']  : '');
            }

            if(isset($rsA[($i - $inicio) + 6 ])){
                $objPHPExcel->setActiveSheetIndex(0)
                    ->setCellValue('BE' . $fila_excel, $rsA[($i - $inicio) + 6  ]['id_paciente'] == $id_paciente_actual ? $rsA[($i - $inicio) + 6  ]['estado_evolucion_pac']  : '');
            }

            if(isset($rsA[($i - $inicio) + 7 ])){
                $objPHPExcel->setActiveSheetIndex(0)
                    ->setCellValue('BF' . $fila_excel, $rsA[($i - $inicio) + 7  ]['id_paciente'] == $id_paciente_actual ? $rsA[($i - $inicio) + 7  ]['estado_evolucion_pac']  : '');
            }

            if(isset($rsA[($i - $inicio) + 8 ])){
                $objPHPExcel->setActiveSheetIndex(0)
                    ->setCellValue('BG' . $fila_excel, $rsA[($i - $inicio) + 8  ]['id_paciente'] == $id_paciente_actual ? $rsA[($i - $inicio) + 8  ]['estado_evolucion_pac']  : '');
            }

            if(isset($rsA[($i - $inicio) + 9 ])){
                $objPHPExcel->setActiveSheetIndex(0)
                    ->setCellValue('BH' . $fila_excel, $rsA[($i - $inicio) + 9  ]['id_paciente'] == $id_paciente_actual ? $rsA[($i - $inicio) + 9  ]['estado_evolucion_pac']  : '');
            }

            if(isset($rsA[($i - $inicio) + 10 ])){
                $objPHPExcel->setActiveSheetIndex(0)
                    ->setCellValue('BI' . $fila_excel, $rsA[($i - $inicio) + 10 ]['id_paciente'] == $id_paciente_actual ? $rsA[($i - $inicio) + 10 ]['estado_evolucion_pac']  : '');
            }

            if(isset($rsA[($i - $inicio) + 11 ])){
                $objPHPExcel->setActiveSheetIndex(0)
                    ->setCellValue('BJ' . $fila_excel, $rsA[($i - $inicio) + 11 ]['id_paciente'] == $id_paciente_actual ? $rsA[($i - $inicio) + 11 ]['estado_evolucion_pac']  : '');
            }

            if(isset($rsA[($i - $inicio) + 12 ])){
                $objPHPExcel->setActiveSheetIndex(0)
                    ->setCellValue('BK' . $fila_excel, $rsA[($i - $inicio) + 12 ]['id_paciente'] == $id_paciente_actual ? $rsA[($i - $inicio) + 12 ]['estado_evolucion_pac']  : '');
            }

            if(isset($rsA[($i - $inicio) + 13 ])){
                $objPHPExcel->setActiveSheetIndex(0)
                    ->setCellValue('BL' . $fila_excel, $rsA[($i - $inicio) + 13 ]['id_paciente'] == $id_paciente_actual ? $rsA[($i - $inicio) + 13 ]['estado_evolucion_pac']  : '');
            }
