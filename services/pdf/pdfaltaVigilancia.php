...
//************************************************
$title = "CONSTANCIA DE VIGILANCIA";
...
$dat_qr = [
    ...
    "info" =>
        ...
        chr(13).chr(10) . 'FECHA INICIO VIGILANCIA:' . $ficha_arr['fecha_inicio_aislamiento'] .
        chr(13).chr(10) . 'FECHA DE CONSTANCIA: ' . $ficha_arr['fecha_alta'] .
...
$pdf->RowX(array(utf8_decode(strtoupper("Fecha Inicio Vigilancia")),utf8_decode("\t".$ficha_arr["fecha_inicio_aislamiento"])));
$pdf->RowX(array(utf8_decode(strtoupper("Fecha Constancia")),utf8_decode("\t".$ficha_arr["fecha_alta"])));
$pdf->RowX(array(utf8_decode(strtoupper("Medico")),utf8_decode("\t".$ficha_arr["medico_alta"])));
...
$aislamiento_text = 'Paciente cumplio los dias de vigilancia';

$pdf->SetFont('Arial','B',10);
$pdf->SetX(10);
$pdf->Cell(95, 6, utf8_decode($aislamiento_text . " ( ".$x_aislamiento." )"), 0, 0, 'L', 0);
$pdf->Cell(95, 6, utf8_decode("Contacto Asintomático ( ". $x_es_asintomatico ." )"), 0, 0, 'L', 0);
$pdf->Ln();
$pdf->Ln();
$pdf->Cell(95, 6, "Vigilancia de contacto culminado", 0, 0, 'L', 0);
